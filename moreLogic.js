...
let arrayLength = myFavoriteNumbers.length;
let finalValue = myFavoriteNumbers[arrayLength - 1]
someNum = myFavoriteNumbers[arrayLength];
if (arrayLength < 7) {
...
someNum = finalValue;
console.log("New value of someNum is " + someNum);
////////// PROBLEM 8 //////////
...
for (let i=0; i < listOfNumbers.length; i++) {
  if (listOfNumbers[i] % 3 === 0) {
    console.log(`${listOfNumbers[i]} is evenly divisible by 3`);
  }
}
